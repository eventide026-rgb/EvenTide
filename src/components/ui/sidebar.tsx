  ...
  (
    ...
    return (
      <aside
        ref={ref}
        className={cn(
            "group/sidebar hidden md:flex flex-col text-sidebar-foreground transition-[width] duration-300 ease-in-out",
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="header"
      className={cn("flex shrink-0 items-center justify-between gap-2 p-2", className)}
      {...props}
    />
  )
})
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="footer"
      className={cn("flex shrink-0 flex-col gap-2 p-2 mt-auto", className)}
      {...props}
    />
  )
})
